...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ["sos-favicon.svg", "robots.txt"],
      manifest: {
        name: "SOS Expats - Espace Prestataires",
        short_name: "SOS Expats",
        description: "Assistant IA pour avocats et expatriés aidants",
        theme_color: "#DC2626",
