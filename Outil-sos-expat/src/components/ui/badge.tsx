  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // SOS Expat type variants
        lawyer: "border-transparent bg-blue-100 text-blue-800",
        expat: "border-transparent bg-emerald-100 text-emerald-800",
        // SOS Expat subscription variants
        active: "border-transparent bg-green-100 text-green-800",
        expired: "border-transparent bg-red-100 text-red-800",
        trialing: "border-transparent bg-purple-100 text-purple-800",
      },
    },
    defaultVariants: {
      variant: "default",
