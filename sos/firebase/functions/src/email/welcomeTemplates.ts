...
type Role = "chatter" | "blogger" | "influencer" | "groupAdmin" | "partner";
...
const ROLE_CONFIGS: Record<Role, RoleConfig> = {
  ...
  partner: {
    ...
    gradientTo: "#4F46E5",
    bgLight: "#EFF6FF",
    dashboardUrl: "https://sos-expat.com/partner/tableau-de-bord",
  },
};
...
function getTranslations(role: Role, lang: Lang, firstName: string): T {
  ...
  const partnerCommissions: Record<Lang, string[]> = {
    fr: ["<strong>Commission n\u00e9goci\u00e9e</strong> sur chaque appel g\u00e9n\u00e9r\u00e9 depuis votre site", "<strong>Tableau de bord d\u00e9di\u00e9</strong> pour suivre vos performances en temps r\u00e9el"],
    en: ["<strong>Negotiated commission</strong> on every call generated from your site", "<strong>Dedicated dashboard</strong> to track your performance in real time"],
    es: ["<strong>Comisi\u00f3n negociada</strong> por cada llamada generada desde tu sitio", "<strong>Panel dedicado</strong> para seguir tu rendimiento en tiempo real"],
    pt: ["<strong>Comiss\u00e3o negociada</strong> em cada chamada gerada pelo seu site", "<strong>Painel dedicado</strong> para acompanhar seu desempenho em tempo real"],
    de: ["<strong>Verhandelte Provision</strong> f\u00fcr jeden Anruf von Ihrer Website", "<strong>Dediziertes Dashboard</strong> zur Echtzeit-Leistungs\u00fcberwachung"],
    ru: ["\u041d\u0435\u0433\u043e\u0446\u0438\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u0430\u044f <strong>\u043a\u043e\u043c\u0438\u0441\u0441\u0438\u044f</strong> \u0437\u0430 \u043a\u0430\u0436\u0434\u044b\u0439 \u0437\u0432\u043e\u043d\u043e\u043a \u0441 \u0432\u0430\u0448\u0435\u0433\u043e \u0441\u0430\u0439\u0442\u0430", "<strong>\u041f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u044c\u043d\u0430\u044f \u043f\u0430\u043d\u0435\u043b\u044c</strong> \u0434\u043b\u044f \u043e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u043d\u0438\u044f \u0440\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442\u043e\u0432"],
    ar: ["<strong>\u0639\u0645\u0648\u0644\u0629 \u0645\u062a\u0641\u0627\u0648\u0636 \u0639\u0644\u064a\u0647\u0627</strong> \u0639\u0644\u0649 \u0643\u0644 \u0645\u0643\u0627\u0644\u0645\u0629 \u0645\u0646 \u0645\u0648\u0642\u0639\u0643", "<strong>\u0644\u0648\u062d\u0629 \u062a\u062d\u0643\u0645 \u0645\u062e\u0635\u0635\u0629</strong> \u0644\u062a\u062a\u0628\u0639 \u0623\u062f\u0627\u0626\u0643"],
    hi: ["\u0906\u092a\u0915\u0940 \u0938\u093e\u0907\u091f \u0938\u0947 \u0939\u0930 \u0915\u0949\u0932 \u092a\u0930 <strong>\u092c\u093e\u0924\u091a\u0940\u0924 \u0915\u092e\u0940\u0936\u0928</strong>", "\u0930\u093f\u092f\u0932-\u091f\u093e\u0907\u092e \u092a\u094d\u0930\u0926\u0930\u094d\u0936\u0928 \u0915\u0947 \u0932\u093f\u090f <strong>\u0938\u092e\u0930\u094d\u092a\u093f\u0924 \u0921\u0948\u0936\u092c\u094b\u0930\u094d\u0921</strong>"],
    zh: ["\u60a8\u7f51\u7ad9\u4ea7\u751f\u7684\u6bcf\u6b21\u901a\u8bdd\u7684<strong>\u534f\u5546\u4f63\u91d1</strong>", "\u7528\u4e8e\u5b9e\u65f6\u8ddf\u8e2a\u4e1a\u7ee9\u7684<strong>\u4e13\u7528\u63a7\u5236\u9762\u677f</strong>"],
  };
  ...
  const roleTexts: Record<Role, Record<Lang, { subject: string; subtitle: string; welcomeTitle: string; welcomeBody: string; commissionsNote: string; tipBody: string }>> = {
    ...
    partner: {
      fr: { subject: "Bienvenue dans le programme Partenaires SOS-Expat !", subtitle: "Votre partenariat est actif !", welcomeTitle: "Bienvenue Partenaire !", welcomeBody: "Votre compte partenaire est actif. Connectez-vous pour acceder a votre tableau de bord, recuperer vos widgets et suivre vos performances.", commissionsNote: "Commission personnalisee, negociee selon votre trafic et votre audience.", tipBody: "Integrez notre widget sur vos pages les plus visitees pour maximiser les conversions !" },
      en: { subject: "Welcome to the SOS-Expat Partners Program!", subtitle: "Your partnership is active!", welcomeTitle: "Welcome Partner!", welcomeBody: "Your partner account is active. Log in to access your dashboard, get your widgets and track your performance.", commissionsNote: "Custom commission, negotiated based on your traffic and audience.", tipBody: "Integrate our widget on your most visited pages to maximize conversions!" },
      es: { subject: "Bienvenido al programa de Socios SOS-Expat!", subtitle: "Tu asociacion esta activa!", welcomeTitle: "Bienvenido Socio!", welcomeBody: "Tu cuenta de socio esta activa. Accede a tu panel para obtener tus widgets.", commissionsNote: "Comision personalizada segun tu trafico.", tipBody: "Integra nuestro widget en tus paginas mas visitadas!" },
      pt: { subject: "Bem-vindo ao programa de Parceiros SOS-Expat!", subtitle: "Sua parceria esta ativa!", welcomeTitle: "Bem-vindo Parceiro!", welcomeBody: "Sua conta de parceiro esta ativa. Acesse seu painel para obter seus widgets.", commissionsNote: "Comissao personalizada de acordo com seu trafego.", tipBody: "Integre nosso widget nas suas paginas mais visitadas!" },
      de: { subject: "Willkommen im SOS-Expat Partner-Programm!", subtitle: "Ihre Partnerschaft ist aktiv!", welcomeTitle: "Willkommen Partner!", welcomeBody: "Ihr Partnerkonto ist aktiv. Melden Sie sich an, um Ihr Dashboard und Widgets zu nutzen.", commissionsNote: "Individuelle Provision basierend auf Ihrem Traffic.", tipBody: "Integrieren Sie unser Widget auf Ihren meistbesuchten Seiten!" },
      ru: { subject: "\u0414\u043e\u0431\u0440\u043e \u043f\u043e\u0436\u0430\u043b\u043e\u0432\u0430\u0442\u044c \u0432 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0443 \u043f\u0430\u0440\u0442\u043d\u0435\u0440\u043e\u0432!", subtitle: "\u0412\u0430\u0448\u0435 \u043f\u0430\u0440\u0442\u043d\u0435\u0440\u0441\u0442\u0432\u043e \u0430\u043a\u0442\u0438\u0432\u043d\u043e!", welcomeTitle: "\u0414\u043e\u0431\u0440\u043e \u043f\u043e\u0436\u0430\u043b\u043e\u0432\u0430\u0442\u044c!", welcomeBody: "\u0412\u0430\u0448 \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u0430\u043a\u0442\u0438\u0432\u0435\u043d. \u0412\u043e\u0439\u0434\u0438\u0442\u0435 \u0434\u043b\u044f \u0434\u043e\u0441\u0442\u0443\u043f\u0430 \u043a \u043f\u0430\u043d\u0435\u043b\u0438.", commissionsNote: "\u0418\u043d\u0434\u0438\u0432\u0438\u0434\u0443\u0430\u043b\u044c\u043d\u0430\u044f \u043a\u043e\u043c\u0438\u0441\u0441\u0438\u044f \u043d\u0430 \u043e\u0441\u043d\u043e\u0432\u0435 \u0432\u0430\u0448\u0435\u0433\u043e \u0442\u0440\u0430\u0444\u0438\u043a\u0430.", tipBody: "\u0420\u0430\u0437\u043c\u0435\u0441\u0442\u0438\u0442\u0435 \u0432\u0438\u0434\u0436\u0435\u0442 \u043d\u0430 \u0441\u0430\u043c\u044b\u0445 \u043f\u043e\u0441\u0435\u0449\u0430\u0435\u043c\u044b\u0445 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430\u0445!" },
      ar: { subject: "\u0645\u0631\u062d\u0628\u0627 \u0628\u0643 \u0641\u064a \u0628\u0631\u0646\u0627\u0645\u062c \u0627\u0644\u0634\u0631\u0643\u0627\u0621!", subtitle: "\u0634\u0631\u0627\u0643\u062a\u0643 \u0646\u0634\u0637\u0629!", welcomeTitle: "\u0645\u0631\u062d\u0628\u0627 \u0634\u0631\u064a\u0643!", welcomeBody: "\u062d\u0633\u0627\u0628\u0643 \u0646\u0634\u0637. \u0633\u062c\u0644 \u0627\u0644\u062f\u062e\u0648\u0644 \u0644\u0644\u0648\u0635\u0648\u0644 \u0625\u0644\u0649 \u0644\u0648\u062d\u0629 \u0627\u0644\u062a\u062d\u0643\u0645.", commissionsNote: "\u0639\u0645\u0648\u0644\u0629 \u0645\u062e\u0635\u0635\u0629 \u062d\u0633\u0628 \u062d\u0631\u0643\u0629 \u0645\u0631\u0648\u0631\u0643.", tipBody: "\u0623\u062f\u0645\u062c \u0627\u0644\u0648\u064a\u062c\u062a \u0641\u064a \u0635\u0641\u062d\u0627\u062a\u0643 \u0627\u0644\u0623\u0643\u062b\u0631 \u0632\u064a\u0627\u0631\u0629!" },
      hi: { subject: "SOS-Expat \u092a\u093e\u0930\u094d\u091f\u0928\u0930 \u092a\u094d\u0930\u094b\u0917\u094d\u0930\u093e\u092e \u092e\u0947\u0902 \u0938\u094d\u0935\u093e\u0917\u0924!", subtitle: "\u0906\u092a\u0915\u0940 \u0938\u093e\u091d\u0947\u0926\u093e\u0930\u0940 \u0938\u0915\u094d\u0930\u093f\u092f \u0939\u0948!", welcomeTitle: "\u0938\u094d\u0935\u093e\u0917\u0924 \u092a\u093e\u0930\u094d\u091f\u0928\u0930!", welcomeBody: "\u0906\u092a\u0915\u093e \u0916\u093e\u0924\u093e \u0938\u0915\u094d\u0930\u093f\u092f \u0939\u0948\u0964 \u0921\u0948\u0936\u092c\u094b\u0930\u094d\u0921 \u0924\u0915 \u092a\u0939\u0941\u0901\u091a\u0928\u0947 \u0915\u0947 \u0932\u093f\u090f \u0932\u0949\u0917\u093f\u0928 \u0915\u0930\u0947\u0902\u0964", commissionsNote: "\u0906\u092a\u0915\u0947 \u091f\u094d\u0930\u0948\u092b\u093f\u0915 \u0915\u0947 \u0906\u0927\u093e\u0930 \u092a\u0930 \u0915\u0938\u094d\u091f\u092e \u0915\u092e\u0940\u0936\u0928\u0964", tipBody: "\u0905\u092a\u0928\u0940 \u0938\u092c\u0938\u0947 \u0905\u0927\u093f\u0915 \u0926\u0947\u0916\u0947 \u0917\u090f \u092a\u0943\u0937\u094d\u0920\u094b\u0902 \u092a\u0930 \u0935\u093f\u091c\u0947\u091f \u0932\u0917\u093e\u090f\u0902!" },
      zh: { subject: "\u6b22\u8fce\u52a0\u5165SOS-Expat\u5408\u4f5c\u4f19\u4f34\u8ba1\u5212\uff01", subtitle: "\u60a8\u7684\u5408\u4f5c\u4f19\u4f34\u5173\u7cfb\u5df2\u6fc0\u6d3b\uff01", welcomeTitle: "\u6b22\u8fce\u5408\u4f5c\u4f19\u4f34\uff01", welcomeBody: "\u60a8\u7684\u5408\u4f5c\u4f19\u4f34\u8d26\u6237\u5df2\u6fc0\u6d3b\u3002\u767b\u5f55\u8bbf\u95ee\u60a8\u7684\u63a7\u5236\u9762\u677f\u3002", commissionsNote: "\u6839\u636e\u60a8\u7684\u6d41\u91cf\u5b9a\u5236\u4f63\u91d1\u3002", tipBody: "\u5728\u60a8\u8bbf\u95ee\u91cf\u6700\u5927\u7684\u9875\u9762\u4e0a\u96c6\u6210\u6211\u4eec\u7684\u5c0f\u7ec4\u4ef6\uff01" },
    },
    groupAdmin: {
