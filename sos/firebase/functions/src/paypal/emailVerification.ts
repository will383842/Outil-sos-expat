...
export const verifyPayPalCode = onCall(
  ...
  async (request) => {
    ...
    await db.collection("notifications").add({
      ...
      titleTranslations: {
        fr: "PayPal vérifié", en: "PayPal verified", es: "PayPal verificado",
        de: "PayPal verifiziert", pt: "PayPal verificado", ru: "PayPal подтверждён",
        hi: "PayPal सत्यापित", zh: "PayPal 已验证", ar: "تم التحقق من PayPal",
      },
      messageTranslations: {
        fr: `Votre adresse PayPal ${normalizedEmail} a été vérifiée. Vous pouvez maintenant recevoir des paiements.`,
        en: `Your PayPal address ${normalizedEmail} has been verified. You can now receive payments.`,
        es: `Su dirección PayPal ${normalizedEmail} ha sido verificada. Ahora puede recibir pagos.`,
        de: `Ihre PayPal-Adresse ${normalizedEmail} wurde verifiziert. Sie können jetzt Zahlungen empfangen.`,
        pt: `Seu endereço PayPal ${normalizedEmail} foi verificado. Agora pode receber pagamentos.`,
        ru: `Ваш PayPal-адрес ${normalizedEmail} подтверждён. Теперь вы можете получать платежи.`,
        hi: `आपका PayPal पता ${normalizedEmail} सत्यापित हो गया। अब आप भुगतान प्राप्त कर सकते हैं।`,
        zh: `您的 PayPal 地址 ${normalizedEmail} 已验证。您现在可以接收付款。`,
        ar: `تم التحقق من عنوان PayPal ${normalizedEmail}. يمكنك الآن استقبال المدفوعات.`,
      },
