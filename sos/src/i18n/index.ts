// src/i18n/index.ts
// -------------------------------------------------------------
// Point d'entrée i18n unique (9 langues) — strict TypeScript, sans dépendance.
// Langues supportées: FR, EN, DE, RU, ZH/CH, ES, PT, AR, HI
...
export function normalizeLang(input: string | null | undefined): Lang | null {
  ...
  if (lower.startsWith('zh') || lower.startsWith('ch')) return 'ch';
