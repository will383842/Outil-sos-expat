...
const ROUTE_TRANSLATIONS: Record<RouteKey, Record<Language, string>> = {
  ...
  "fiches-pays": {
    ...
    es: "categories/fiches-pays",
    de: "categories/fiches-pays",
    ru: "categories/fiches-pays",
    pt: "categories/fiches-pays",
    ch: "categories/fiches-pays",
    hi: "categories/fiches-pays",
    ar: "categories/fiches-pays",
  },
  "fiches-thematiques": {
    fr: "categories/fiches-thematiques",
    en: "categories/thematic-guides",
    es: "categories/fiches-thematiques",
    de: "categories/fiches-thematiques",
    ru: "categories/fiches-thematiques",
    pt: "categories/fiches-thematiques",
    ch: "categories/fiches-thematiques",
    hi: "categories/fiches-thematiques",
    ar: "categories/fiches-thematiques",
  },
  "programme-chatter": {
    fr: "categories/programme",
    en: "categories/programme",
    es: "categories/programme",
    de: "categories/programme",
    ru: "categories/programme",
    pt: "categories/programme",
    ch: "categories/programme",
    hi: "categories/programme",
    ar: "categories/programme",
  },
  "programme-affiliation": {
    fr: "categories/affiliation",
    en: "categories/affiliation",
    es: "categories/affiliation",
    de: "categories/affiliation",
    ru: "categories/affiliation",
    pt: "categories/affiliation",
    ch: "categories/affiliation",
    hi: "categories/affiliation",
    ar: "categories/affiliation",
  },
  "sondages-listing": {
    fr: "categories/sondages",
    en: "categories/surveys",
    es: "categories/sondages",
    de: "categories/sondages",
    ru: "categories/sondages",
    pt: "categories/sondages",
    ch: "categories/sondages",
    hi: "categories/sondages",
    ar: "categories/sondages",
  },
  "sondages": {
    fr: "sondages",
    en: "surveys",
  ...
  "outils-listing": {
    ...
    en: "categories/tools",
    es: "categories/outils",
    de: "categories/outils",
    ru: "categories/outils",
    pt: "categories/outils",
    ch: "categories/outils",
    hi: "categories/outils",
    ar: "categories/outils",
  },
  "outils": {
    fr: "outils",
    en: "tools",
