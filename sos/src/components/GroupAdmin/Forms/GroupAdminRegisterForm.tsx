    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {step === 1 && (
        <div className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="form.firstName" defaultMessage="First name" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="form.lastName" defaultMessage="Last name" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-300 pointer-events-none" />
                <input
          ...
          <div className="space-y-1">
            <label className={darkStyles.label}>
              <FormattedMessage id="form.email" defaultMessage="Email" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
            </label>
            <div className="relative">
          ...
          {!isLoggedIn && (
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="form.password" defaultMessage="Password" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="form.country" defaultMessage="Country" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <DarkDropdown
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="form.language" defaultMessage="Language" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <DarkDropdown
      ...
      {step === 2 && (
        <div className="space-y-5">
          ...
          <div className="space-y-1">
            <label className={darkStyles.label}>
              <FormattedMessage id="groupadmin.register.groupUrl" defaultMessage="Group / Community URL" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              {savedUrls.length > 0 && (
          ...
          <div className="space-y-1">
            <label className={darkStyles.label}>
              <FormattedMessage id="groupadmin.register.groupName" defaultMessage="Group Name" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
            </label>
            <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="groupadmin.register.groupType" defaultMessage="Group Type" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <DarkDropdown
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="groupadmin.register.groupSize" defaultMessage="Group Size" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <DarkDropdown
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className={darkStyles.label}>
                <FormattedMessage id="groupadmin.register.groupCountry" defaultMessage="Group Country" /> <span className="text-red-400 font-bold text-lg">*</span> <span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-red-500 rounded-md">OBLIGATOIRE</span>
              </label>
              <DarkDropdown
