...
const InfluencerAffiliateLinks: React.FC<InfluencerAffiliateLinksProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/10 border border-red-200/50 dark:border-red-800/30 rounded-2xl p-4 sm:p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="hidden sm:inline-flex px-3 py-1.5 rounded-full bg-red-500/10 text-red-600 dark:text-red-400 font-bold text-sm">
            {clientCode}
          </span>
        </div>
        ...
        <div className="space-y-2">
          <div className="w-full bg-white dark:bg-gray-800 rounded-xl px-4 py-3 min-h-[48px] font-mono text-sm text-gray-700 dark:text-gray-300 overflow-x-auto border border-gray-200 dark:border-gray-700 flex items-center">
            <span className="truncate">{clientLink}</span>
          </div>
          <div className="flex gap-2">
            <button
              onClick={() => copyToClipboard(clientLink, 'client')}
              className="flex-1 min-h-[48px] rounded-xl bg-red-500 hover:bg-red-600 text-white transition-colors flex items-center justify-center gap-2 font-medium active:scale-[0.98]"
            ...
            <a
              ...
              className="min-h-[48px] min-w-[48px] rounded-xl bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 transition-colors flex items-center justify-center active:scale-[0.98]"
        ...
        <div className="mt-3 flex items-center gap-2 sm:hidden">
          ...
          <span className="font-mono font-bold text-red-600 dark:text-red-400 text-base">{clientCode}</span>
        </div>
      </div>

      {/* Recruitment Link - Mobile optimized */}
      <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/10 border border-purple-200/50 dark:border-purple-800/30 rounded-2xl p-4 sm:p-5">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-purple-500 flex items-center justify-center shadow-lg shadow-purple-500/30">
          ...
          <span className="hidden sm:inline-flex px-3 py-1.5 rounded-full bg-purple-500/10 text-purple-600 dark:text-purple-400 font-bold text-sm">
            {recruitmentCode}
          </span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 min-h-[48px] rounded-xl bg-purple-500 hover:bg-purple-600 text-white transition-colors flex items-center justify-center gap-2 font-medium active:scale-[0.98]"
              title={intl.formatMessage({ id: 'common.copy', defaultMessage: 'Copier' })}
            >
        ...
        <div className="mt-3 flex items-center gap-2 sm:hidden">
          ...
          <span className="font-mono font-bold text-purple-600 dark:text-purple-400 text-base">{recruitmentCode}</span>
        </div>
      </div>
    </div>
  );
