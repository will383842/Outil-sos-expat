...
const WISE_COUNTRIES: CountryOption[] = [
  ...
  { code: 'MC', name: 'Monaco', nameEn: 'Monaco', flag: '🇲🇨', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'AD', name: 'Andorre', nameEn: 'Andorra', flag: '🇦🇩', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'SM', name: 'Saint-Marin', nameEn: 'San Marino', flag: '🇸🇲', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'VA', name: 'Vatican', nameEn: 'Vatican City', flag: '🇻🇦', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  ...
  { code: 'ME', name: 'Montenegro', nameEn: 'Montenegro', flag: '🇲🇪', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'XK', name: 'Kosovo', nameEn: 'Kosovo', flag: '🇽🇰', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  ...
  { code: 'LI', name: 'Liechtenstein', nameEn: 'Liechtenstein', flag: '🇱🇮', currency: 'CHF', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // UK
  ...
  { code: 'IS', name: 'Islande', nameEn: 'Iceland', flag: '🇮🇸', currency: 'ISK', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // Central & Eastern Europe (non-EUR)
  ...
  // Balkans (non-EUR)
  { code: 'RS', name: 'Serbie', nameEn: 'Serbia', flag: '🇷🇸', currency: 'RSD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'BA', name: 'Bosnie-Herzegovine', nameEn: 'Bosnia and Herzegovina', flag: '🇧🇦', currency: 'BAM', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'MK', name: 'Macedoine du Nord', nameEn: 'North Macedonia', flag: '🇲🇰', currency: 'MKD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'AL', name: 'Albanie', nameEn: 'Albania', flag: '🇦🇱', currency: 'ALL', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // Eastern Europe & Caucasus
  { code: 'UA', name: 'Ukraine', nameEn: 'Ukraine', flag: '🇺🇦', currency: 'UAH', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'MD', name: 'Moldavie', nameEn: 'Moldova', flag: '🇲🇩', currency: 'MDL', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'GE', name: 'Georgie', nameEn: 'Georgia', flag: '🇬🇪', currency: 'GEL', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'AM', name: 'Armenie', nameEn: 'Armenia', flag: '🇦🇲', currency: 'AMD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'AZ', name: 'Azerbaidjan', nameEn: 'Azerbaijan', flag: '🇦🇿', currency: 'AZN', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // North America
  ...
  { code: 'AR', name: 'Argentine', nameEn: 'Argentina', flag: '🇦🇷', currency: 'ARS', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'CL', name: 'Chili', nameEn: 'Chile', flag: '🇨🇱', currency: 'CLP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'CO', name: 'Colombie', nameEn: 'Colombia', flag: '🇨🇴', currency: 'COP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PE', name: 'Perou', nameEn: 'Peru', flag: '🇵🇪', currency: 'PEN', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'VE', name: 'Venezuela', nameEn: 'Venezuela', flag: '🇻🇪', currency: 'VES', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'EC', name: 'Equateur', nameEn: 'Ecuador', flag: '🇪🇨', currency: 'USD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BO', name: 'Bolivie', nameEn: 'Bolivia', flag: '🇧🇴', currency: 'BOB', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PY', name: 'Paraguay', nameEn: 'Paraguay', flag: '🇵🇾', currency: 'PYG', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'UY', name: 'Uruguay', nameEn: 'Uruguay', flag: '🇺🇾', currency: 'UYU', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'GY', name: 'Guyana', nameEn: 'Guyana', flag: '🇬🇾', currency: 'GYD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'SR', name: 'Suriname', nameEn: 'Suriname', flag: '🇸🇷', currency: 'SRD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'GF', name: 'Guyane francaise', nameEn: 'French Guiana', flag: '🇬🇫', currency: 'EUR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // Central America
  { code: 'PA', name: 'Panama', nameEn: 'Panama', flag: '🇵🇦', currency: 'USD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'CR', name: 'Costa Rica', nameEn: 'Costa Rica', flag: '🇨🇷', currency: 'CRC', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'NI', name: 'Nicaragua', nameEn: 'Nicaragua', flag: '🇳🇮', currency: 'NIO', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'HN', name: 'Honduras', nameEn: 'Honduras', flag: '🇭🇳', currency: 'HNL', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'SV', name: 'Salvador', nameEn: 'El Salvador', flag: '🇸🇻', currency: 'USD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'GT', name: 'Guatemala', nameEn: 'Guatemala', flag: '🇬🇹', currency: 'GTQ', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BZ', name: 'Belize', nameEn: 'Belize', flag: '🇧🇿', currency: 'BZD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Caribbean
  { code: 'JM', name: 'Jamaique', nameEn: 'Jamaica', flag: '🇯🇲', currency: 'JMD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'TT', name: 'Trinite-et-Tobago', nameEn: 'Trinidad and Tobago', flag: '🇹🇹', currency: 'TTD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'DO', name: 'Republique dominicaine', nameEn: 'Dominican Republic', flag: '🇩🇴', currency: 'DOP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'HT', name: 'Haiti', nameEn: 'Haiti', flag: '🇭🇹', currency: 'HTG', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BB', name: 'Barbade', nameEn: 'Barbados', flag: '🇧🇧', currency: 'BBD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BS', name: 'Bahamas', nameEn: 'Bahamas', flag: '🇧🇸', currency: 'BSD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'LC', name: 'Sainte-Lucie', nameEn: 'Saint Lucia', flag: '🇱🇨', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'GD', name: 'Grenade', nameEn: 'Grenada', flag: '🇬🇩', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'VC', name: 'Saint-Vincent-et-les-Grenadines', nameEn: 'Saint Vincent and the Grenadines', flag: '🇻🇨', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'AG', name: 'Antigua-et-Barbuda', nameEn: 'Antigua and Barbuda', flag: '🇦🇬', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'DM', name: 'Dominique', nameEn: 'Dominica', flag: '🇩🇲', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'KN', name: 'Saint-Kitts-et-Nevis', nameEn: 'Saint Kitts and Nevis', flag: '🇰🇳', currency: 'XCD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PR', name: 'Porto Rico', nameEn: 'Puerto Rico', flag: '🇵🇷', currency: 'USD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber', 'routingNumber'] },
  { code: 'CW', name: 'Curacao', nameEn: 'Curacao', flag: '🇨🇼', currency: 'ANG', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'AW', name: 'Aruba', nameEn: 'Aruba', flag: '🇦🇼', currency: 'AWG', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // East Asia
  { code: 'JP', name: 'Japon', nameEn: 'Japan', flag: '🇯🇵', currency: 'JPY', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'KR', name: 'Coree du Sud', nameEn: 'South Korea', flag: '🇰🇷', currency: 'KRW', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'CN', name: 'Chine', nameEn: 'China', flag: '🇨🇳', currency: 'CNY', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  ...
  { code: 'TW', name: 'Taiwan', nameEn: 'Taiwan', flag: '🇹🇼', currency: 'TWD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Southeast Asia
  ...
  { code: 'VN', name: 'Vietnam', nameEn: 'Vietnam', flag: '🇻🇳', currency: 'VND', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'ID', name: 'Indonesie', nameEn: 'Indonesia', flag: '🇮🇩', currency: 'IDR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PH', name: 'Philippines', nameEn: 'Philippines', flag: '🇵🇭', currency: 'PHP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'MM', name: 'Myanmar', nameEn: 'Myanmar', flag: '🇲🇲', currency: 'MMK', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'KH', name: 'Cambodge', nameEn: 'Cambodia', flag: '🇰🇭', currency: 'KHR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'LA', name: 'Laos', nameEn: 'Laos', flag: '🇱🇦', currency: 'LAK', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BN', name: 'Brunei', nameEn: 'Brunei', flag: '🇧🇳', currency: 'BND', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'TL', name: 'Timor oriental', nameEn: 'Timor-Leste', flag: '🇹🇱', currency: 'USD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // South Asia
  { code: 'IN', name: 'Inde', nameEn: 'India', flag: '🇮🇳', currency: 'INR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber', 'ifsc'] },
  { code: 'PK', name: 'Pakistan', nameEn: 'Pakistan', flag: '🇵🇰', currency: 'PKR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BD', name: 'Bangladesh', nameEn: 'Bangladesh', flag: '🇧🇩', currency: 'BDT', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'LK', name: 'Sri Lanka', nameEn: 'Sri Lanka', flag: '🇱🇰', currency: 'LKR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'NP', name: 'Nepal', nameEn: 'Nepal', flag: '🇳🇵', currency: 'NPR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'MV', name: 'Maldives', nameEn: 'Maldives', flag: '🇲🇻', currency: 'MVR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'BT', name: 'Bhoutan', nameEn: 'Bhutan', flag: '🇧🇹', currency: 'BTN', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Mongolia
  { code: 'MN', name: 'Mongolie', nameEn: 'Mongolia', flag: '🇲🇳', currency: 'MNT', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Central Asia
  { code: 'KZ', name: 'Kazakhstan', nameEn: 'Kazakhstan', flag: '🇰🇿', currency: 'KZT', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'UZ', name: 'Ouzbekistan', nameEn: 'Uzbekistan', flag: '🇺🇿', currency: 'UZS', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'TM', name: 'Turkmenistan', nameEn: 'Turkmenistan', flag: '🇹🇲', currency: 'TMT', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'KG', name: 'Kirghizistan', nameEn: 'Kyrgyzstan', flag: '🇰🇬', currency: 'KGS', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'TJ', name: 'Tadjikistan', nameEn: 'Tajikistan', flag: '🇹🇯', currency: 'TJS', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'AF', name: 'Afghanistan', nameEn: 'Afghanistan', flag: '🇦🇫', currency: 'AFN', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Middle East
  ...
  { code: 'SA', name: 'Arabie saoudite', nameEn: 'Saudi Arabia', flag: '🇸🇦', currency: 'SAR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'QA', name: 'Qatar', nameEn: 'Qatar', flag: '🇶🇦', currency: 'QAR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'KW', name: 'Koweit', nameEn: 'Kuwait', flag: '🇰🇼', currency: 'KWD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'BH', name: 'Bahrein', nameEn: 'Bahrain', flag: '🇧🇭', currency: 'BHD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'OM', name: 'Oman', nameEn: 'Oman', flag: '🇴🇲', currency: 'OMR', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'IL', name: 'Israel', nameEn: 'Israel', flag: '🇮🇱', currency: 'ILS', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'JO', name: 'Jordanie', nameEn: 'Jordan', flag: '🇯🇴', currency: 'JOD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'LB', name: 'Liban', nameEn: 'Lebanon', flag: '🇱🇧', currency: 'LBP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'IQ', name: 'Irak', nameEn: 'Iraq', flag: '🇮🇶', currency: 'IQD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'YE', name: 'Yemen', nameEn: 'Yemen', flag: '🇾🇪', currency: 'YER', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  // Turkey
  { code: 'TR', name: 'Turquie', nameEn: 'Turkey', flag: '🇹🇷', currency: 'TRY', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // North Africa
  { code: 'EG', name: 'Egypte', nameEn: 'Egypt', flag: '🇪🇬', currency: 'EGP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'MA', name: 'Maroc', nameEn: 'Morocco', flag: '🇲🇦', currency: 'MAD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'DZ', name: 'Algerie', nameEn: 'Algeria', flag: '🇩🇿', currency: 'DZD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'TN', name: 'Tunisie', nameEn: 'Tunisia', flag: '🇹🇳', currency: 'TND', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  { code: 'LY', name: 'Libye', nameEn: 'Libya', flag: '🇱🇾', currency: 'LYD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['iban'] },
  // Oceania
  ...
  { code: 'FJ', name: 'Fidji', nameEn: 'Fiji', flag: '🇫🇯', currency: 'FJD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PG', name: 'Papouasie-Nouvelle-Guinee', nameEn: 'Papua New Guinea', flag: '🇵🇬', currency: 'PGK', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'NC', name: 'Nouvelle-Caledonie', nameEn: 'New Caledonia', flag: '🇳🇨', currency: 'XPF', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'PF', name: 'Polynesie francaise', nameEn: 'French Polynesia', flag: '🇵🇫', currency: 'XPF', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'WS', name: 'Samoa', nameEn: 'Samoa', flag: '🇼🇸', currency: 'WST', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'TO', name: 'Tonga', nameEn: 'Tonga', flag: '🇹🇴', currency: 'TOP', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'VU', name: 'Vanuatu', nameEn: 'Vanuatu', flag: '🇻🇺', currency: 'VUV', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
  { code: 'SB', name: 'Iles Salomon', nameEn: 'Solomon Islands', flag: '🇸🇧', currency: 'SBD', provider: 'wise', methodType: 'bank_transfer', bankFields: ['accountNumber'] },
];
...
const FLUTTERWAVE_COUNTRIES: CountryOption[] = [
  ...
  { code: 'ZM', name: 'Zambie', nameEn: 'Zambia', flag: '🇿🇲', currency: 'ZMW', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mtn_momo', 'airtel_money'] },
  { code: 'MW', name: 'Malawi', nameEn: 'Malawi', flag: '🇲🇼', currency: 'MWK', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['airtel_money', 'mpesa'] },
  { code: 'MZ', name: 'Mozambique', nameEn: 'Mozambique', flag: '🇲🇿', currency: 'MZN', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mpesa', 'mtn_momo'] },
  { code: 'ZW', name: 'Zimbabwe', nameEn: 'Zimbabwe', flag: '🇿🇼', currency: 'ZWL', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['ecocash'] },
  { code: 'BW', name: 'Botswana', nameEn: 'Botswana', flag: '🇧🇼', currency: 'BWP', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'NA', name: 'Namibie', nameEn: 'Namibia', flag: '🇳🇦', currency: 'NAD', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'LS', name: 'Lesotho', nameEn: 'Lesotho', flag: '🇱🇸', currency: 'LSL', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mpesa'] },
  { code: 'SZ', name: 'Eswatini', nameEn: 'Eswatini', flag: '🇸🇿', currency: 'SZL', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mtn_momo'] },
  { code: 'ET', name: 'Ethiopie', nameEn: 'Ethiopia', flag: '🇪🇹', currency: 'ETB', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mpesa'] },
  { code: 'DJ', name: 'Djibouti', nameEn: 'Djibouti', flag: '🇩🇯', currency: 'DJF', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'SC', name: 'Seychelles', nameEn: 'Seychelles', flag: '🇸🇨', currency: 'SCR', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'CV', name: 'Cap-Vert', nameEn: 'Cape Verde', flag: '🇨🇻', currency: 'CVE', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'GM', name: 'Gambie', nameEn: 'Gambia', flag: '🇬🇲', currency: 'GMD', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['afrimoney'] },
  { code: 'SL', name: 'Sierra Leone', nameEn: 'Sierra Leone', flag: '🇸🇱', currency: 'SLL', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['orange_money', 'afrimoney'] },
  { code: 'LR', name: 'Liberia', nameEn: 'Liberia', flag: '🇱🇷', currency: 'LRD', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['orange_money', 'mtn_momo'] },
  { code: 'SO', name: 'Somalie', nameEn: 'Somalia', flag: '🇸🇴', currency: 'SOS', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['hormuud'] },
  { code: 'ER', name: 'Erythree', nameEn: 'Eritrea', flag: '🇪🇷', currency: 'ERN', provider: 'flutterwave', methodType: 'mobile_money' },
  { code: 'SS', name: 'Soudan du Sud', nameEn: 'South Sudan', flag: '🇸🇸', currency: 'SSP', provider: 'flutterwave', methodType: 'mobile_money', mobileProviders: ['mtn_momo'] },
  { code: 'AO', name: 'Angola', nameEn: 'Angola', flag: '🇦🇴', currency: 'AOA', provider: 'flutterwave', methodType: 'mobile_money' },
];
...
const MOBILE_PROVIDERS: MobileProviderOption[] = [
  { id: 'orange_money', name: 'Orange Money', displayName: 'Orange Money', countries: ['SN', 'CI', 'ML', 'BF', 'NE', 'CM', 'GN', 'CD', 'MG', 'MA', 'TN', 'MU', 'GW', 'CF', 'GQ', 'SL', 'LR'], color: '#FF6600' },
  { id: 'wave', name: 'Wave', displayName: 'Wave', countries: ['SN', 'CI'], color: '#00D4FF' },
  { id: 'mtn_momo', name: 'MTN MoMo', displayName: 'MTN Mobile Money', countries: ['CI', 'BJ', 'CM', 'GH', 'NG', 'UG', 'RW', 'GN', 'CG', 'ZM', 'MZ', 'SZ', 'LR', 'SS'], color: '#FFCC00' },
  { id: 'moov_money', name: 'Moov Money', displayName: 'Moov Money', countries: ['CI', 'ML', 'BF', 'NE', 'TG', 'BJ', 'GA', 'TD', 'MR'], color: '#0066CC' },
  { id: 'airtel_money', name: 'Airtel Money', displayName: 'Airtel Money', countries: ['NE', 'GA', 'CG', 'CD', 'GH', 'NG', 'KE', 'TZ', 'UG', 'RW', 'TD', 'MG', 'ZM', 'MW'], color: '#FF0000' },
  { id: 'mpesa', name: 'M-Pesa', displayName: 'M-Pesa', countries: ['CD', 'KE', 'TZ', 'MW', 'MZ', 'LS', 'ET'], color: '#00A650' },
  ...
  { id: 'ecocash', name: 'EcoCash', displayName: 'EcoCash', countries: ['ZW'], color: '#00A550' },
  { id: 'afrimoney', name: 'Afrimoney', displayName: 'Afrimoney', countries: ['GM', 'SL'], color: '#FF9900' },
  { id: 'hormuud', name: 'Hormuud', displayName: 'Hormuud Telecom', countries: ['SO'], color: '#0099CC' },
];
...
const PHONE_COUNTRY_CODES: Record<string, string> = {
  ...
  'MG': '+261', 'MU': '+230', 'GW': '+245', 'GQ': '+240', 'ZM': '+260',
  'MW': '+265', 'MZ': '+258', 'ZW': '+263', 'BW': '+267', 'NA': '+264',
  'LS': '+266', 'SZ': '+268', 'ET': '+251', 'DJ': '+253', 'SC': '+248',
  'CV': '+238', 'GM': '+220', 'SL': '+232', 'LR': '+231', 'SO': '+252',
  'ER': '+291', 'SS': '+211', 'AO': '+244',
};
