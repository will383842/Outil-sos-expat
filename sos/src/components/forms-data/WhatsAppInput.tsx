...
import { Locale, getDetectedBrowserLanguage, normalize, getLocalizedLabel, makeAdaptiveStyles, SharedOption, getNoOptionsMessage } from './shared';
    ...
    <div className={className} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
      <div style={{ minWidth: '12rem', flex: '0 0 auto' }}>
        <Select<DialOption, false>
          ...
          isSearchable={true}
          isDisabled={disabled}
          noOptionsMessage={({ inputValue }) => getNoOptionsMessage(currentLocale, inputValue)}
          filterOption={() => true}
        />
      </div>
      <input
