...
const I18N = {
  ...
  es: {
    ...
    hint: "Arrastra la imagen para reposicionarla. Usa los controles para ajustar.",
    preview: "Vista previa:",
    finalSize: "Tamaño final:",
    quality: "Formato optimizado, alta calidad",
    zoom: "Zoom",
    rotate: "Rotar 90°",
    cancel: "Cancelar",
    validate: "Aplicar",
    processing: "Procesando...",
    altToCrop: "Imagen para recortar",
    altPreview: "Vista previa del recorte",
  },
  de: {
    title: "Bild zuschneiden",
    hint: "Ziehen Sie das Bild, um es neu zu positionieren. Verwenden Sie die Steuerelemente zum Anpassen.",
    preview: "Vorschau:",
    finalSize: "Endgröße:",
    quality: "Optimiertes Format, hohe Qualität",
    zoom: "Zoom",
    rotate: "90° drehen",
    cancel: "Abbrechen",
    validate: "Anwenden",
    processing: "Verarbeitung...",
    altToCrop: "Bild zum Zuschneiden",
    altPreview: "Zuschnitt-Vorschau",
  },
  ru: {
    title: "Обрезать изображение",
    hint: "Перетащите изображение, чтобы изменить его положение. Используйте элементы управления для настройки.",
    preview: "Предпросмотр:",
    finalSize: "Конечный размер:",
    quality: "Оптимизированный формат, высокое качество",
    zoom: "Увеличение",
    rotate: "Повернуть на 90°",
    cancel: "Отмена",
    validate: "Применить",
    processing: "Обработка...",
    altToCrop: "Изображение для обрезки",
    altPreview: "Предпросмотр обрезки",
  },
  pt: {
    title: "Recortar imagem",
    hint: "Arraste a imagem para reposicioná-la. Use os controles para ajustar.",
    preview: "Visualização:",
    finalSize: "Tamanho final:",
    quality: "Formato otimizado, alta qualidade",
    zoom: "Zoom",
    rotate: "Girar 90°",
    cancel: "Cancelar",
    validate: "Aplicar",
    processing: "Processando...",
    altToCrop: "Imagem para recortar",
    altPreview: "Visualização do recorte",
  },
  hi: {
    title: "छवि काटें",
    hint: "पुनः स्थिति के लिए छवि को खींचें। समायोजन के लिए नियंत्रणों का उपयोग करें।",
    preview: "पूर्वावलोकन:",
    finalSize: "अंतिम आकार:",
    quality: "अनुकूलित प्रारूप, उच्च गुणवत्ता",
    zoom: "ज़ूम",
    rotate: "90° घुमाएं",
    cancel: "रद्द करें",
    validate: "लागू करें",
    processing: "प्रसंस्करण...",
    altToCrop: "काटने के लिए छवि",
    altPreview: "काटने का पूर्वावलोकन",
  },
  ch: {
    title: "裁剪图像",
    hint: "拖动图像以重新定位。使用控件进行调整。",
    preview: "预览：",
    finalSize: "最终大小：",
    quality: "优化格式，高质量",
    zoom: "缩放",
