...
const globalStyles = `
  ...
  .influencer-landing h1,
  .influencer-landing h2,
  .influencer-landing h3 {
    color: white;
  }
...
const InfluencerLanding: React.FC = () => {
  ...
  const faqs = [
    ...
    { question: intl.formatMessage({ id: 'influencer.faq.q8', defaultMessage: "Can I recruit lawyers or helpers?" }), answer: intl.formatMessage({ id: 'influencer.faq.a8', defaultMessage: "Yes! Find lawyers or expat helpers to join the platform. You earn {providerCall}$/call for a recruited lawyer or {providerCallExp}$/call for an expat helper during their first {linkDuration} months. It's passive income from their success!" }, { providerCall: rates.providerCall, providerCallExp: rates.providerCallExp, linkDuration: rates.linkDuration }) },
  ];
      ...
      <div className="influencer-landing bg-black text-white">
        ...
        <section className="section-content bg-gradient-to-b from-black to-gray-950" aria-labelledby="section-role">
          <div className="max-w-7xl mx-auto">
            <h2 id="section-role" className="!text-3xl sm:!text-3xl lg:!text-4xl xl:!text-5xl font-black text-center mb-3 sm:mb-4">
            ...
            <div className="grid lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
              <article className="bg-gradient-to-br from-red-500/20 to-orange-500/10 border rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
                ...
                <div className="flex gap-2">
                  {['youtube', 'instagram', 'tiktok', 'blog'].map((p) => (
                    <span key={p} className="px-3 py-1 bg-white/10 text-white rounded-full font-medium">
              ...
              <article className="bg-gradient-to-br from-purple-500/20 to-pink-500/10 border rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
                ...
                <div className="text-sm font-bold mb-2"><FormattedMessage id="influencer.step2.label" defaultMessage="STEP 2" /></div>
                <h3 className="!text-2xl sm:!text-2xl lg:!text-3xl font-bold text-white mb-3 sm:mb-4">
        ...
        ================================================================ */}
        <section className="section-content bg-gray-950" aria-labelledby="section-profiles">
          <div className="max-w-7xl mx-auto">
            <h2 id="section-profiles" className="!text-3xl sm:!text-3xl lg:!text-4xl xl:!text-5xl font-black text-center mb-3 sm:mb-4">
            ...
            <div className="grid lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
              {[
                ...
                <div key={profile.id} className="bg-white/10 border rounded-xl sm:rounded-2xl p-4 sm:p-5 hover:border-white/20 transition-colors">
            ...
            <div className="grid sm:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
              {contentTypes.map((content, idx) => (
                <div key={idx} className={`bg-white/10 border rounded-xl sm:rounded-2xl p-3 sm:p-4 text-center ${content.highlight ? 'border-red-500/40 ring-1 ring-red-500/20' : 'border-white/10'}`}>
                  ...
                  {content.highlight && <div className="mt-2 text-xs font-semibold"><FormattedMessage id="influencer.content.recommended" defaultMessage="High conversion!" /></div>}
                </div>
              ))}
            </div>
        ...
        ================================================================ */}
        <section className="section-content bg-gray-950" aria-labelledby="section-calc">
          <div className="max-w-7xl mx-auto">
            <h2 id="section-calc" className="!text-3xl sm:!text-3xl lg:!text-4xl xl:!text-5xl font-black text-center mb-3 sm:mb-4">
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white/10 border rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8">
                <div className="space-y-5 sm:space-y-6">
                  {[
                    ...
                    <div key={s.label}>
                      <label className="flex items-center justify-between text-sm font-medium mb-2">
                        ...
                        <span className="text-green-400 font-bold">{s.fmt ? s.value.toLocaleString() : s.value}{s.suffix || ''}</span>
                      </label>
                      <input
                        type="range"
                        min={s.min}
                  ...
                  <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/10 border rounded-2xl p-5 text-center">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-12 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-purple-500/15 to-pink-500/10 border rounded-2xl p-5 sm:p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="text-2xl sm:text-3xl font-black">${rates.providerCallRange}{local(rates.providerCallMax)}</div>
        ...
        <section className="section-content bg-gradient-to-b from-gray-950 via-orange-950/20 to-gray-950" aria-labelledby="section-network">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-base sm:text-lg lg:text-xl mb-8 sm:mb-12">
              <FormattedMessage id="influencer.network.subtitle" defaultMessage={`Recruit lawyers and expat helpers. Earn $${rates.providerCallRange} per call they receive for ${rates.linkDuration} months!`} />
            </p>
            ...
            <div className="bg-white/10 border rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-10 max-w-3xl mx-auto">
              <div className="flex items-center">
                ...
                <span className="text-xs sm:text-sm"><FormattedMessage id="influencer.network.you.earn" defaultMessage={`$${rates.clientCallMax}/client + $${rates.providerCallRange}/call from partners`} /></span>

                <div className="text-2xl sm:text-3xl my-3 sm:my-4" aria-hidden="true">↓</div>

                <div className="flex justify-center gap-4 sm:gap-8">
                  {[
                    { emoji: '⚖️', label: intl.formatMessage({ id: 'influencer.network.lawyer', defaultMessage: 'Lawyer' }), rate: rates.providerCall },
                    { emoji: '🌍', label: intl.formatMessage({ id: 'influencer.network.helper', defaultMessage: 'Helper' }), rate: rates.providerCallExp },
                  ].map((item, i) => (
                    <div key={i} className="flex items-center">
                      ...
                      <span className="text-xs">+${item.rate}/call</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-6 sm:mt-8 bg-green-500/10 border rounded-2xl p-4 text-center">
                ...
                <p className="text-xl sm:text-2xl font-black">= ${rates.providerCallMax * 60}/month <FormattedMessage id="influencer.network.passive" defaultMessage={`passive income for ${rates.linkDuration} months!`} /></p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-content bg-gray-950" aria-labelledby="section-proof">
          <div className="max-w-7xl mx-auto">
            <h2 id="section-proof" className="!text-3xl sm:!text-3xl lg:!text-4xl xl:!text-5xl font-black text-center mb-8 sm:mb-12">
            ...
            {/* Payment methods */}
            <div className="bg-white/10 border rounded-2xl sm:rounded-3xl p-5 sm:p-6 text-center max-w-3xl mx-auto">
              <h3 className="text-base sm:text-lg font-bold mb-4"><FormattedMessage id="influencer.payment.title" defaultMessage="Get Paid Your Way" /></h3>
