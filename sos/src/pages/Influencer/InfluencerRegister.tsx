...
const InfluencerRegister: React.FC = () => {
  ...
  const benefits = [
    { icon: <Gift className="w-5 h-5 text-red-400" />, text: intl.formatMessage({ id: 'influencer.register.benefit1', defaultMessage: 'Commission par client parrainé' }) },
    { icon: <Users className="w-5 h-5 text-purple-400" />, text: intl.formatMessage({ id: 'influencer.register.benefit2.v3', defaultMessage: 'Commission par appel à vos partenaires recrutés' }) },
