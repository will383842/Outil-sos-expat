...
const HowItWorksPage: React.FC = () => {
  ...
  const structuredData = {
    ...
    "image": { "@type": "ImageObject", "url": "https://sos-expat.com/og-image.webp", "width": 1200, "height": 630 },
    "totalTime": "PT5M",
    "step": [
      {
        "@type": "HowToStep",
      ...
      <nav aria-label="breadcrumb" className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <ol className="flex flex-wrap items-center gap-1.5 text-sm text-gray-500">
            <li>
              <Link to={`/${language}`} className="hover:text-red-600 transition-colors">
            ...
            <li className="text-gray-900 font-medium">{intl.formatMessage({ id: 'howItWorks.title1', defaultMessage: 'How it works' })}</li>
          </ol>
        </div>
      </nav>
