                  ...
                  <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                      ...
                      <div className="space-y-4 mt-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-1">
                            <label htmlFor="firstName" className={s.label}><FormattedMessage id="form.firstName" defaultMessage="First name" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                          ...
                          {/* Last Name */}
                          <div className="space-y-1">
                            <label htmlFor="lastName" className={s.label}><FormattedMessage id="form.lastName" defaultMessage="Last name" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                            <div className="relative">
                              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 z-10 pointer-events-none" />
                        ...
                        {/* Email */}
                        <div className="space-y-1">
                          <label htmlFor="email" className={s.label}><FormattedMessage id="form.email" defaultMessage="Email" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                          <div className="relative">
                        ...
                        <div className="space-y-2">
                          <label htmlFor="password" className={s.label}><FormattedMessage id="form.password" defaultMessage="Password" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                          <div className="relative">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div ref={countryDropdownRef} className="space-y-2">
                            <label className={s.label}><FormattedMessage id="form.country" defaultMessage="Country" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                            <div className="relative">
                    ...
                    <div>
                      ...
                      <div className="space-y-4 mt-4">
                        {/* Blog URL */}
                        <div className="space-y-1">
                          <label htmlFor="blogUrl" className={s.label}><FormattedMessage id="form.blogUrl" defaultMessage="Blog URL" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                          <div className="relative">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          {/* Blog Name */}
                          <div className="space-y-1">
                            <label htmlFor="blogName" className={s.label}><FormattedMessage id="form.blogName" defaultMessage="Blog name" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                            <div className="relative">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div ref={blogCountryDropdownRef} className="space-y-2">
                            <label className={s.label}><FormattedMessage id="form.blogCountry" defaultMessage="Target country" /><span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span></label>
                            <div className="relative">
                              <Globe className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 z-10" />
                    ...
                    <div className="space-y-2">
                      <label className="flex items-start gap-3 cursor-pointer select-none">
                        ...
                        <span className="text-sm leading-relaxed">
                          ...
                          />
                          <span className="text-purple-400 font-bold text-lg ml-0.5">*</span><span className="inline-flex items-center px-2 py-0.5 ml-2 text-[10px] font-bold text-white bg-purple-500 rounded-md">OBLIGATOIRE</span>
                        </span>
                      </label>
