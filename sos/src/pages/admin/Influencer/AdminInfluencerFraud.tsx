/**
 * AdminInfluencerFraud - Fraud detection page for the Influencer referral system
 *
 * Reuses the same backend as Chatter fraud (adminGetReferralFraudAlerts)
 * filtered to influencer-related alerts.
 */
...
const AdminInfluencerFraud: React.FC = () => {
          ...
          <DialogContent className="max-w-lg">
            ...
            {selectedAlert && (
              <div className="space-y-4 py-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Influenceur</p>
                  <div className="mt-1">
...
export default AdminInfluencerFraud;
