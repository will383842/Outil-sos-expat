...
const getDocumentTypes = (intl: ReturnType<typeof import('react-intl').useIntl>) => [
  ...
  { value: 'terms_chatters', label: intl.formatMessage({ id: 'admin.legal.docType.terms_chatters', defaultMessage: 'Terms of Service - Chatters' }), icon: '💬', required: true, page: '/cgu-chatters' },
  { value: 'terms_influencers', label: intl.formatMessage({ id: 'admin.legal.docType.terms_influencers', defaultMessage: 'Terms of Service - Influencers' }), icon: '📢', required: true, page: '/cgu-influenceurs' },
  { value: 'terms_bloggers', label: intl.formatMessage({ id: 'admin.legal.docType.terms_bloggers', defaultMessage: 'Terms of Service - Bloggers' }), icon: '✍️', required: true, page: '/cgu-bloggers' },
  { value: 'terms_group_admins', label: intl.formatMessage({ id: 'admin.legal.docType.terms_group_admins', defaultMessage: 'Terms of Service - Group Admins' }), icon: '👥', required: true, page: '/cgu-group-admins' },
  { value: 'terms_affiliate', label: intl.formatMessage({ id: 'admin.legal.docType.terms_affiliate', defaultMessage: 'Affiliate Program Terms (Centralized)' }), icon: '🤝', required: true, page: '/cgu-affiliation' },
