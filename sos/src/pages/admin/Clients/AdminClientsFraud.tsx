/**
 * AdminClientsFraud - Fraud detection page for the Client referral system
 *
 * Reuses the same backend (adminGetReferralFraudAlerts) filtered to client-related alerts.
 */
...
const AdminClientsFraud: React.FC = () => {
...
export default AdminClientsFraud;
