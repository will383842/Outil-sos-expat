/**
 * AdminClientsAnalytics - Admin analytics dashboard for the Client affiliate system
 *
 * Displays KPI cards, status distribution, and top earners table.
 * Uses adminGetAffiliateUsersList callable with role=client.
 */
...
const AdminClientsAnalytics: React.FC = () => {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
              <BarChart3 className="w-7 h-7 sm:w-8 sm:h-8 text-emerald-500" />
              Analytics Clients (Affiliation)
            </h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Vue d'ensemble des performances d'affiliation des clients
            </p>
          </div>
          <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card>
                <CardContent className="p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Clients Affilies</p>
                ...
                <CardContent className="p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">Cumul tous clients</p>
                    </div>
              ...
              <Card>
                <CardContent className="p-5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Gains moyens / client</p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg flex items-center gap-2">
                  ...
                  Top 10 Clients par gains d'affiliation
                </CardTitle>
              </CardHeader>
              <CardContent>
                {data.topEarners.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Aucun client avec des gains pour le moment</p>
                  </div>
                ) : (
...
export default AdminClientsAnalytics;
