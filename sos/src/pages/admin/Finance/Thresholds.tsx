...
export default function Thresholds() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      setError('Erreur lors du chargement des donnees de seuils');
    } finally {
      setIsLoading(false);
    }
  }, []);
  ...
  const handleInitialize = async () => {
    if (!confirm('Initialiser le tracking pour tous les pays configures?')) {
      return;
    }
  ...
  const handleMarkAsRegistered = async () => {
    if (!registrationModal || !registrationModal.registrationNumber) {
      alert('Veuillez entrer un numero d\'enregistrement');
      return;
    }
      ...
      <AdminLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-gray-600">Chargement des seuils fiscaux...</p>
          </div>
        </div>
      </AdminLayout>
    );
      ...
      <AdminLayout>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                ...
                Seuils Fiscaux Internationaux
              </h1>
              <p className="text-gray-600 mt-2">
                Surveillance des seuils d'enregistrement TVA/GST par pays
              </p>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-red-800 font-semibold">
                    {summary.criticalCount} seuil(s) critique(s) requierent votre attention
                  </h3>
                  <p className="text-red-700 text-sm mt-1">
                    {criticalThresholds.map(t => t.countryName).join(', ')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-b border-gray-200 mb-6">
            <nav className="flex space-x-8">
              {[
                ...
                { id: 'countries', label: 'Par pays', icon: MapPin },
                { id: 'alerts', label: `Alertes${summary.unacknowledgedAlerts > 0 ? ` (${summary.unacknowledgedAlerts})` : ''}`, icon: Bell },
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Pays surveilles</p>
                      <p className="text-3xl font-bold text-gray-900 mt-1">{summary.total}</p>
                      <p className="text-xs text-green-600 mt-1">
                        {summary.safe} en securite
                      </p>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">CA Total (EUR)</p>
                ...
                <div className="p-6">
                  {trackings.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">Aucun seuil configure</p>
                      <button
                            ...
                            <div className="flex items-center">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-red-600">
                                  {tracking.percentageUsed.toFixed(1)}% du seuil atteint
                                </p>
                                {config && (
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  >
                    ...
                    <option value="SAFE">En securite</option>
                    <option value="WARNING_70">Attention (70%)</option>
                    <option value="WARNING_90">Critique (90%)</option>
                    <option value="EXCEEDED">Depasse</option>
                    <option value="REGISTERED">Enregistre</option>
                  </select>
                  <select
                            ...
                            <div className="flex items-center justify-end gap-2">
                              ...
                              {!tracking.isRegistered && (
                                <button
                                  ...
                                  title="Marquer comme enregistre"
                                >
                                  <Shield className="w-4 h-4" />
                                </button>
                              )}
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                {alerts.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-gray-500">Aucune alerte recente</p>
                  </div>
                ) : (
                  <div className="divide-y divide-gray-200">
                    {alerts.map(alert => (
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {THRESHOLD_CONFIGS.map(config => (
                        <tr key={config.countryCode}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {config.b2cOnly ? 'B2C uniquement' : 'B2C + B2B'}
                          </td>
        ...
        {registrationModal && (
          <Modal
            ...
            title={`Enregistrer ${registrationModal.countryName}`}
            size="medium"
          >
            <div className="space-y-4">
              <p className="text-gray-600">
                Enregistrez le numero de TVA/GST pour {registrationModal.countryName}.
                Cela marquera ce pays comme "Enregistre" et arretera les alertes de seuil.
              </p>
              <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-500">
                  Periode: {viewingTracking.period}
                </span>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-600">Progression vers le seuil</span>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-500">Montant EUR</p>
              ...
              <div className="border-t pt-4">
                <h4 className="font-medium text-gray-900 mb-2">Alertes envoyees</h4>
              ...
              {viewingTracking.isRegistered && (
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-center gap-2 text-blue-800">
                    ...
                    <span className="font-medium">Enregistre pour la TVA</span>
                  </div>
                  {viewingTracking.registrationNumber && (
                    <p className="text-sm text-blue-600 mt-1">
                      Numero: {viewingTracking.registrationNumber}
                    </p>
                  )}
                  {viewingTracking.registrationDate && (
                    <p className="text-sm text-blue-600">
                      Date: {formatDate(viewingTracking.registrationDate)}
                    </p>
                  )}
                </div>
              )}
              ...
              <div className="text-sm text-gray-500 border-t pt-4">
                <p>Derniere transaction: {formatDate(viewingTracking.lastTransactionAt)}</p>
                <p>Derniere mise a jour: {formatDate(viewingTracking.updatedAt)}</p>
              </div>
            </div>
          </Modal>
        )}
            ...
            <div className="space-y-4">
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">
                  {viewingAlert.percentageAtAlert.toFixed(1)}% du seuil atteint
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
