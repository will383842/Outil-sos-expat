 ...
 *
 * Admin page for managing influencer promotions/hackathons.
...
const COMMISSION_TYPES = [
  ...
  { value: "recurring_call", label: "Recurring Call" },
  { value: "subscription", label: "Subscription" },
  { value: "provider_bonus", label: "Provider Bonus" },
];
...
const AdminInfluencersPromotions: React.FC = () => {
                ...
                <TableBody>
                  {promotions.map((promo) => (
                    <TableRow key={promo.id}>
                      ...
                      <TableCell>
                        <span className="font-bold text-purple-600">x{promo.multiplier}</span>
                      </TableCell>
                      <TableCell>
...
export default AdminInfluencersPromotions;
