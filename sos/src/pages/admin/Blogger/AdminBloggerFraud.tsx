/**
 * AdminBloggerFraud - Fraud detection page for the Blogger referral system
 *
 * Reuses the same backend as Chatter fraud (adminGetReferralFraudAlerts)
 * filtered to blogger-related alerts.
 */
...
const AdminBloggerFraud: React.FC = () => {
          ...
          <DialogContent className="max-w-lg">
            ...
            {selectedAlert && (
              <div className="space-y-4 py-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Blogueur</p>
                  <div className="mt-1">
...
export default AdminBloggerFraud;
