/**
 * AdminPartnersFraud - Fraud detection page for the Partner referral system
 *
 * Reuses the same backend as other fraud pages (adminGetReferralFraudAlerts)
 * filtered to partner-related alerts.
 */
...
const AdminPartnersFraud: React.FC = () => {
...
export default AdminPartnersFraud;
