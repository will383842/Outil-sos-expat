/**
 * AdminGroupAdminFraud - Fraud detection page for the GroupAdmin referral system
 *
 * Reuses the same backend as Chatter fraud (adminGetReferralFraudAlerts)
 * filtered to groupAdmin-related alerts.
 */
...
const AdminGroupAdminFraud: React.FC = () => {
...
export default AdminGroupAdminFraud;
