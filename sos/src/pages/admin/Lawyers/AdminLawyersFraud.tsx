/**
 * AdminLawyersFraud - Fraud detection page for the Lawyer referral system
 *
 * Reuses the same backend (adminGetReferralFraudAlerts) filtered to lawyer-related alerts.
 */
...
const AdminLawyersFraud: React.FC = () => {
          ...
          <DialogContent className="max-w-lg">
            ...
            {selectedAlert && (
              <div className="space-y-4 py-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Avocat</p>
                  <div className="mt-1">
...
export default AdminLawyersFraud;
