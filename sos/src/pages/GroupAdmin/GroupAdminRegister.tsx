  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content={intl.formatMessage({ id: 'groupadmin.register.seo.description', defaultMessage: 'Register as a Group Admin to earn $5 (lawyer) or $3 (expat) per call referred.' })} />
        ...
        <div className="max-w-lg mx-auto relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">
              <FormattedMessage id="groupadmin.register.subtitle" defaultMessage="Earn $5 (lawyer) or $3 (expat) per call referred from your group" />
            </p>
          </div>
