...
const GroupAdminResources: React.FC = () => {
  ...
  const fetchResources = async () => {
    try {
      setLoading(true);
      const getResources = httpsCallable(functionsAffiliate, 'getGroupAdminResources');
  ...
  const copyContent = async (resource: GroupAdminResource) => {
    ...
    if (!processedContent[resource.id]) {
      ...
      try {
        const getContent = httpsCallable(functionsAffiliate, 'getGroupAdminProcessedResourceContent');
    ...
    // Track usage
    try {
      const trackUsage = httpsCallable(functionsAffiliate, 'trackGroupAdminResourceUsage');
