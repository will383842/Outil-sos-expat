  ...
  return (
    <Layout showFooter={false}>
      <SEOHead
        ...
        description={intl.formatMessage({ id: 'groupAdmin.landing.seo.description', defaultMessage: 'Monetize your Facebook group. Earn $10 for each call generated by your affiliate link, plus a $5 discount for your community on every call. Ready-to-use tools in 9 languages.' })}
      />
          ...
          <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
            ...
            <p style={{ fontSize: '1rem' }} className="text-gray-300 mb-5 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
              <FormattedMessage
                ...
                defaultMessage="Help your expat members with legal assistance. Earn $10 per call generated by your link + your members get $5 off every call."
              />
            </p>
