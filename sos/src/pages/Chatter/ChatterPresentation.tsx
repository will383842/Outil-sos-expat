...
const ChatterPresentation: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: intl.formatMessage({ id: 'chatter.presentation.slide2.title', defaultMessage: 'Comment ça marche ?' }),
      content: intl.formatMessage({ id: 'chatter.presentation.slide2.content', defaultMessage: 'Vous recevez deux liens uniques : un pour les clients et un pour recruter des prestataires. Chaque conversion vous rapporte une commission.' }),
    ...
    },
    {
      ...
      title: intl.formatMessage({ id: 'chatter.presentation.slide5.title', defaultMessage: 'Passez le quiz' }),
      content: intl.formatMessage({ id: 'chatter.presentation.slide5.content', defaultMessage: 'Pour devenir Chatter actif, vous devez passer un quiz de 10 questions (score minimum 85%). Vous avez 5 minutes. Bonne chance !' }),
