...
function ChatterHowToEarn() {
  const intl = useIntl();
  const { user } = useAuth();
  const { dashboardData, isLoading, clientShareUrl } = useChatter();
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ============================================================ */}
      {/* SECTION 1: 3 STEPS - Ultra simple */}
      {/* ============================================================ */}
      <div className={`${UI.card} p-6`}>
      ...
      {/* ============================================================ */}
      {/* SECTION 2: ALL COMMISSIONS - Le tableau complet */}
      {/* ============================================================ */}
      <div className={`${UI.card} p-6`}>
      ...
      {/* ============================================================ */}
      {/* SECTION 3: RECRUITMENT MILESTONES */}
      {/* ============================================================ */}
      <div className={`${UI.card} p-6`}>
        <div className="flex items-center gap-2 mb-4">
      ...
      {/* ============================================================ */}
      {/* SECTION 4: CAPTAIN SECTION (conditional) */}
      {/* ============================================================ */}
      {isCaptain && (
