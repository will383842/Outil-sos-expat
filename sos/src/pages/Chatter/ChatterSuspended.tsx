    ...
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 dark:from-gray-950 via-red-50/30 dark:via-gray-950 to-white dark:to-black px-4 py-12">
        <div className="max-w-md w-full">
          <div className={`${UI.card} p-8 text-center shadow-lg`}>
            {/* Icon */}
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`${UI.button.secondary} w-full py-3 flex items-center justify-center gap-2 ${SPACING.touchTarget}`}
              >
              ...
              <button
                ...
                className="text-slate-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-gray-200 flex items-center justify-center gap-2"
              >
