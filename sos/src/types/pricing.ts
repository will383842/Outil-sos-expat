...
/**
 * Devises supportées pour le pricing des SERVICES (appels aux prestataires)
 * Note: Utilise minuscules pour cohérence avec pricingService.ts et les composants checkout
 * À ne pas confondre avec subscription.ts qui utilise 'EUR'/'USD' pour les abonnements IA
 */
export type ServiceCurrency = "eur" | "usd";
export type Currency = ServiceCurrency; // Alias pour compatibilité
