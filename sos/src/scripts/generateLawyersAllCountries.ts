...
const LAWYER_SPECIALTIES = [
  ...
  'FAM_MARIAGE_MIXTE', 'FAM_ADOPTION_INTERNATIONALE', 'FISC_FISCALITE_EXPATS',
  'FISC_DOUBLE_IMPOSITION', 'FISC_OPTIMISATION_FISCALE', 'FISC_SUCCESSION_INTERNATIONALE',
  'IMM_ACHAT_IMMOBILIER_ETRANGER', 'IMM_BAIL_COMMERCIAL_INTERNATIONAL', 'IMM_LITIGE_IMMOBILIER',
  'ENT_CREATION_SOCIETE', 'ENT_DROIT_COMMERCIAL_INTERNATIONAL', 'ENT_FUSION_ACQUISITION',
  'CIV_ACCIDENTS_ETRANGER', 'CIV_RESPONSABILITE_CIVILE', 'CIV_ASSURANCE_INTERNATIONALE',
  'SUC_TESTAMENT_INTERNATIONAL', 'SUC_HERITAGE_TRANSFRONTALIER',
];
