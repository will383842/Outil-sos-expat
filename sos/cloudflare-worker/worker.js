...
async function handleRequest(request, env, ctx) {
  ...
  // directory.xml sitemap is generated by Blog but URLs are served by SPA via JS rendering

  // Gallery segments — listing = SPA React, detail = Blog SSR
  // Source: localeRoutes.ts "galerie" key (fr/de=galerie, en/ru/zh/hi/ar=gallery, es/pt=galeria)
  ...
  function isBlogPath(path) {
    ...
    if (match) {
      ...
      // Gallery: detail only → Blog SSR ; listing = SPA React
